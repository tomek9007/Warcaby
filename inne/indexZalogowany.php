<?php
	session_start();		
	if(!isset($_SESSION['zalogowany']))		//jesli niezalogowany probuje sie dostac przez wstukanie w przegladarce
	{
...
?>
	...
	<div id="blok">
		...
		<div id="rozegraneMecze">
					<table id="mecze">
						<tr>
							<td>Przeciwnik // Data // Wynik</td>
						</tr>
						<tr>
							<td><?php require_once "rozegrane.php";?></td>
						</tr>
					</table>					
					<br />
			</div>
		...
		<div id="aktualneMecze">
				...
				<div id="ustawieniaGry">
					...
					<table>
												...
												<tr><td>
												<button type="button" onclick='setActiveStyleSheet("bl","or")'><?php echo $lang['DELETE']; ?></button>
												</td><td></td>
												</tr>
